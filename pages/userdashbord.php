            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header d-flex align-items-center">
                  <h4>MHAZINI DASHBOARD  </h4>
                </div>
					<div class="card-body">
   
                 <center><h1><strong class="text-warning">KARIBU MHAZINI / MHASIBU TAG</strong></h1></center>
                 <center><h4><strong class="text-secondary">MUNGU KWETU NI KIMBILIO</strong></h4></center>
                 <center><h4><strong class="text-secondary">Weka taarifa muhimu hapa</strong></h4></center>
