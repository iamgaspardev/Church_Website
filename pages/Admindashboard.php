      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
			...
			<li><a href="Taarifa.php"> <i class="fa fa-list"></i>TAARIFA  SADAKA                       </a></li>
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header d-flex align-items-center">
                 ...
                 <center><h1><strong class="text-warning">MANAGE ALL OF THE CHURCH HERE</strong></h1></center>
                 <center><h4><strong class="text-secondary">MUNGU KWETU NI KIMBILIO</strong></h4></center>
                 <center><h4><strong class="text-secondary">Manage all here</strong></h4></center>
				 <center><h4><strong class="text-secondary"></strong></h4></center>
                </div>
