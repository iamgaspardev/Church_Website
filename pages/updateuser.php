    ...
    <tbody>
        ...
        <?php 
            ...
            while ($row = mysqli_fetch_array($select_users)) {
			  ...
			  echo "<td><a  href='updateuser.php?delete=$user_id'style= 'color:red'class='delete'><i class='material-icons'style= 'color:red'  data-toggle='tooltip'title='Delete'>&#xE872;</i></a></td>";
			  echo "</tr>";
             }
        ?>
