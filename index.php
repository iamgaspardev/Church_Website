...
<body>
    ...
    <div class="intro-container">
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(assets/img/intro-carousel/ac.jpg)">
          ...
          <div class="carousel-item" style="background-image: url(assets/img/intro-carousel/ab.jpg)">
            <div class="carousel-container">
              <div class="container">
                  <h2 class="animate__animated animate__fadeInDown">KANISA LA KIINJILI LA KIRUTHERI TANZANIA</h2>
				<h4 class="animate__animated animate__fadeInDown"><strong class="text-success">KKKT MBEYA</strong></h4>
          ...
          <div class="carousel-item" style="background-image: url(assets/img/intro-carousel/ac.jpg)">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">KANISA LA KIINJILI LA KIRUTHERI TANZANIA</h2>
				<h4 class="animate__animated animate__fadeInDown"><strong class="text-success">KKKT MBEYA</strong></h4>
    ...
    <section id="about">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h3>KKKT NEW FOREST MBEYA</h3>
          <p>Tupo Jijini Mbeya Eneo la Forest ya zamani Karibu na Chuo Kikuu Cha Mzumbe</p>
        </header>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>2020-2025</strong>. All Rights Reserved
      </div>
      <div class="credits">
        Designed by <a href="#">GasparMazima</a><br>
		kalugendosmazima@gmail.com
      </div>
    </div>
  </footer><!-- End Footer -->
